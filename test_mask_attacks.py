    ...
    for i in range(len(source_list)):
        ...
        for j in range(len(target_list)):
            ...
            for b_align_crop in img_b_align_crop_list:
                #b_align_crop shape: [1,3,224,224]
                ...
                swap_result = model(None, b_align_crop_tenor, latend_id, None, True) #[1,3,224,224]
                
                swap_result_save = swap_result[0].cpu().detach().numpy()
                ...
                y = swap_result.cpu().detach()

                #对比swap_result和b_align_crop_tenor,计算mask
                
                mask = abs(y-b_align_crop_tenor.cpu().detach())
