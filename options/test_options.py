...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--output_path", type=str, default='./output/normal_result', help="results path")
        self.parser.add_argument("--adv_output_path", type=str, default='./output/adv_result', help="adversarial results path")
